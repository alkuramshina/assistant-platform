...
- Product and infrastructure truth lives in `README.md`.
...
- If `.planning/` conflicts with `README.md`, follow `README.md` and update `.planning` afterward.

## Documentation Policy

- Keep durable product docs in `README.md`. Prefer one concise document over many files.
...
- For docs-only edits, check stale historical terms with `Select-String` or `rg`.
