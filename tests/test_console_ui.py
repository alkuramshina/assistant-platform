...
class ConsoleUITest(unittest.TestCase):
    ...
    def test_index_serves_working_console(self) -> None:
        ...
        self.assertIn('id="provider-base-url"', body)
    ...
    def test_static_assets_include_api_wiring(self) -> None:
        ...
        self.assertIn("providerBaseUrls", body)
        self.assertIn("requirePresetBaseUrl", body)
        self.assertIn("option.dataset.baseUrl = requirePresetBaseUrl(preset)", body)
        ...
        self.assertIn("https://openrouter.ai/api/v1", body)
        self.assertIn("syncProviderBaseUrl", body)
